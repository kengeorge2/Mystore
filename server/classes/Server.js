...
// Database
import Database_Mystore_db from "./Database_Mystore_db.js";

// Controllers
import InventoryRequestController from "../controllers/Mystore_db/InventoryRequestController";
import ProductController from "../controllers/Mystore_db/ProductController";
import ProductCategoryController from "../controllers/Mystore_db/ProductCategoryController";
import UserController from "../controllers/Mystore_db/UserController";
...
class Server {
 ...
 // End Init Database
    ...
    // Start Init Controllers
		InventoryRequestController.init(router);
		ProductController.init(router);
		ProductCategoryController.init(router);
